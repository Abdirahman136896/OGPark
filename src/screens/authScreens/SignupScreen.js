...
const initialValues = {phoneNumber:'',fullName:"",password:"",email:''}
        ...
        <ScrollView keyboardShouldPersistTaps = "always">
            ...
            <Formik initialValues ={initialValues} onSubmit = {(values)=>{signUp(values)}}>
                {(props)=>(
                    <View style ={styles.view2}>
                        <View>
                            <Text style ={styles.text2}>New on OGPark ?</Text>
                        </View>
                            ...
                            <View style = {styles.view14}>
                                ...
                                <TouchableOpacity onPress={togglePasswordVisibility}>
                                    <Animatable.View  animation = {passwordBlured?"fadeInLeft":"fadeInRight"} duration ={400}>
                                        <Icon name={isPasswordVisible ? 'visibility' : 'visibility-off'} color ={colors.grey3}  type = "material" style ={{marginRight:10}}/>
                                    </Animatable.View>
                                </TouchableOpacity>   
                            </View>
            ...
            <View style ={styles.view19}>
                <View style ={styles.view20}>
                    <Text style ={styles.text6}>Already have an account with OGPark ?</Text>
                </View>
